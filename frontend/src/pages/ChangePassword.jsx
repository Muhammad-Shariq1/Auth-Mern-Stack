...
const ChangePassword = () => {
    ...
    const handleChangePassword = async () => {
        ...
        try {
            setIsLoading(true)
            const res = await axios.post(`${import.meta.env.VITE_API_URL}/user/change-password/${email}`, {
                newPassword,
                confirmPassword
            })
    ...
    return (
        <div className='min-h-screen flex items-center justify-center bg-stone-100 px-4'>
            <div className='bg-white shadow-md rounded-lg p-5 max-w-md w-full'>
                <h2 className='text-2xl font-semibold mb-4 text-center text-black'>Change Password</h2>
