...
const Login = () => {
    ...
    return (
        <div className='relative w-full h-screen md:h-[760px] bg-stone-100 overflow-hidden'>
            <div className='min-h-screen flex flex-col to-muted/20'>
                <div className='flex-1 flex items-center justify-center p-4'>
                    <div className='w-full max-w-md space-y-6 flex flex-col items-center'>
                        <div className='text-center space-y-2'>
                            <h1 className='text-3xl font-bold tracking-tight text-black'>Login into your account</h1>
                        ...
                        <Card className="w-full max-w-sm">
                            ...
                            <CardFooter className="flex-col gap-2">
                                <Button onClick={handleSubmit} type="submit" className="w-full bg-black hover:bg-gray-800 text-white">
                                    {
                                        isLoading ? (
                                            <>
